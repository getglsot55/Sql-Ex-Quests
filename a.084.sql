...
-- ƒл€ каждой компании подсчитать количество перевезенных пассажиров (если они были в этом мес€це) по декадам апрел€ 2003.
-- ѕри этом учитывать только дату вылета. 
-- ¬ывод: название компании, количество пассажиров за каждую декаду 
